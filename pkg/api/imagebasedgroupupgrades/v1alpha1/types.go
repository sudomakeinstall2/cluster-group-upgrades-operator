...
type ImageBasedGroupUpgradeSpec struct {
	...
	// +kubebuilder:validation:XValidation:rule="[[['Prep']], [['Prep'], ['Upgrade']], [['Prep', 'Upgrade']], [['Prep'], ['Upgrade'], ['Finalize']], [['Prep'], ['Upgrade', 'Finalize']], [['Prep', 'Upgrade'], ['Finalize']], [['Prep', 'Upgrade', 'Finalize']], [['Rollback']], [['Rollback'], ['Finalize']], [['Rollback', 'Finalize']], [['Upgrade']], [['Upgrade'], ['Finalize']], [['Upgrade', 'Finalize']], [['Idle']], [['Prep'], ['Abort']], [['Prep'], ['Upgrade'], ['Rollback']], [['Prep', 'Upgrade'], ['Rollback']], [['Prep'], ['Upgrade'], ['Rollback'], ['Finalize']], [['Prep'], ['Upgrade'], ['Rollback', 'Finalize']], [['Prep', 'Upgrade'], ['Rollback'], ['Finalize']], [['Prep', 'Upgrade'], ['Rollback', 'Finalize']], [['Upgrade'], ['Rollback']], [['Upgrade'], ['Rollback'], ['Finalize']], [['Upgrade'], ['Rollback', 'Finalize']]].exists(x, x==self.map(y, y.actions))",message="invalid combinations of actions in the plan"
